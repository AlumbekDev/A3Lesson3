...
import com.example.a3lesson3.databinding.FragmentWeatherBinding;
        ...
        if (checkConnection()) {
                ...
                public void onChanged(Resource<WeatherModel> resource) {
                    switch (resource.status) {
                        case SUCCESS: {
                            ...
                            setLol(cityName);
                            String iconUrl = "https://api.openweathermap.org/data/2.5/" + resource.data.getWeather().get(0).getIcon()
                                    + "@2x.png";
                            ...
                            binding.location.setText(args.getCityName());
            ...
            viewModel.localLiveData.observe(getViewLifecycleOwner(), new Observer<WeatherModel>() {
                ...
                public void onChanged(WeatherModel data) {
                    ...
                    setLol(cityName);
                    String iconUrl = "https://api.openweathermap.org/data/2.5/" + data.getWeather().get(0).getIcon()
                            + "@2x.png";
